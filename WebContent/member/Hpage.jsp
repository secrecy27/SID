...
<!-- main -->
      ...
      <div id="container">
        		 ...
        		 <div id="hPageContainer">
        			...
        			<div id="selectingUi">
        				<input type="image" src="" style="display:none" class="selMap img-circle" id="controlOne"/>
        				<input type="image" src="" style="display:none" class="selMap img-circle" id="controlTwo"/>
        			</div>
        			<div id="saveLoad">
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#loadModal">불러오기</button>
						
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#saveModal">저장하기</button>
					</div>
					...
					<div class="box barOne"> 	
						...
						<div id="baseButton">
							<input type="image" class="baseImage img-circle" onclick="createEntity('a')" src="../img/img1.png"> 
						</div>
						<br>
						<div id="baseButton">
							<input type="image" class="baseImage img-circle" onclick="createEntity('b')" src="../img/img2.png">
						</div>
						<br>
						<div id="baseButton">
							<input type="image" class="baseImage img-circle" onclick="createEntity('c')" src="../img/img3.png">
						</div>
						<br>
					</div>
					...
					<div class="box barTwo" id="barTwo">
						...
						<div class="outerButton">
							<div class="mapButton">
								...
								<input type="image" src="../img/pattern.png" class="mb" value="off">
						...
						<div class="outerButton">
							<div class="mapButton">
								<button class="useMapButton btn btn-default btn-circle">use</button>
								<input type="image" src="../img/pattern2.jpg" class="mb" value="off">
								<p class="mapCheck" style="display:none">0</p>
							</div>
						</div>
						<div class="outerButton">
							<div class="mapButton">
							<button class="useMapButton btn btn-default btn-circle">use</button>
							<input type="image"  src="../img/UV_Grid_Sm.jpg" class="mb" value="off">
							<p class="mapCheck" style="display:none">0</p>
							</div>
						</div>
						<div class="outerButton">
